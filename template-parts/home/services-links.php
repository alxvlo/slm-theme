...
$branding_url         = slm_for_businesses_url();
  ...
  <div class="container">
    ...
    <div class="home-services__grid">
      ...
      <a class="home-serviceCard" href="<?php echo esc_url($photography_url); ?>" aria-label="Real Estate Photography">
        ...
        <p><?php echo esc_html(get_post_meta($pid, 'hp_service_1_body', true) ?: "MLS-ready photos that sell before the first showing and attract buyers."); ?></p>
      </a>
