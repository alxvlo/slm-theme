  ...
  <div class="container">
    ...
    <div class="home-who__grid js-reveal">
      ...
      <div class="home-who__col">
        ...
        <a class="btn btn--outline-light home-who__cta" href="<?php echo esc_url(slm_for_businesses_url()); ?>"><?php echo esc_html(get_post_meta($pid, 'hp_who_biz_cta', true) ?: "View Business Services"); ?></a>
      </div>
    </div>
