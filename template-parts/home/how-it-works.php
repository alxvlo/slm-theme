  ...
  <div class="container">
    ...
    <div class="home-how__grid">
      ...
      <article class="home-howCard">
        ...
        <p><?php echo esc_html(get_post_meta($pid, 'hp_step_4_body', true) ?: "Go live with content that turns views into showings and gets your listing or brand noticed."); ?></p>
      </article>
    </div>
