  ...
  if ($template === 'templates/page-about.php') {
    return [
      ...
      'slm_about_values_list' => [
        'label' => 'Core Values (Format: Title | Description, one per line)',
        'type' => 'textarea',
        'default' => implode("\n", [
      ...
      'slm_about_outcomes_list' => [
        'label' => 'Outcomes List (One per line)',
        'type' => 'textarea',
        'default' => implode("\n", [
      ...
      'slm_about_traditional_list' => [
        'label' => 'Traditional List (One per line)',
        'type' => 'textarea',
        'default' => implode("\n", [
      ...
      'slm_about_showcase_list' => [
        'label' => 'Showcase List (One per line)',
        'type' => 'textarea',
        'default' => implode("\n", [
      ...
      'slm_about_owner_name' => ['label' => 'Owner Name', 'type' => 'text', 'default' => 'Brittney Pitts Jaxs'],
      'slm_about_owner_role' => ['label' => 'Owner Role', 'type' => 'text', 'default' => 'Founder'],
      'slm_about_owner_bio' => ['label' => 'Owner Bio', 'type' => 'textarea', 'default' => 'Before launching Showcase Listings Media, Brittney worked in the industry alongside agents — inside the deadlines, the pressure, and the constant need to stay visible online while still doing the job. She saw the same pattern repeatedly: marketing mattered, but the way it was offered did not fit real life. Everything was priced per add-on, per revision, or treated like a luxury instead of a practical business tool. That experience shaped every part of how Showcase Listings Media operates today — built around consistency, accessibility, and results that agents can actually sustain.'],
