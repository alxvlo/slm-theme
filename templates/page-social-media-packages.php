...
slm_page_seo(
  'Social Media Content Packages | Showcase Listings Media',
  'Monthly reel, photo, and short-form video packages for North Florida businesses and real estate agents. Scroll-stopping content, produced for you.'
);
